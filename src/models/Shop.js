...
const shopSchema = new mongoose.Schema({
    ...
    description: { type: String, maxlength: shopConfig.maxSellerProfileDescriptionLength, trim: true, default: "" },
    logo: { type: String, maxlength: shopConfig.maxSellerLogoLength, trim: true, default: "" },
